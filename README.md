...
Compute nucleotide diversity (π) and divergence (Dxy, Da) from ITS2 sequences
Perform molecular docking (Vina, GNINA) across multiple grid sizes (24 Å, 28 Å, 32 Å)
Identify whether canonical (F167Y, E198A, F200Y) or novel variants (G308W, A352D) disrupt the benzimidazole binding site
Integrate genomic and structural results to support drug-resistance surveillance
